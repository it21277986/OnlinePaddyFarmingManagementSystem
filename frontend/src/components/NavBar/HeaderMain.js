...
function HeaderMain(){
    const myImage = require('./GreenfieldPro Logo.png');
              ...
              <ul className="navbar-nav navbar-nav-hover ms-auto">
                ...
                <div className="row">
                                <div className="col-sm">
                                    <Link to={`../register`} style={{backgroundColor:"#246d1c"}}  className="btn btn-outline-success"><span className="button-text">Signup</span></Link><br />
                                </div>
                                <div className="col-sm" style={{marginRight:"10px"}}>
                                    <Link to={`../loginCus`} style={{backgroundColor:"#246d1c"}}  className="btn btn-outline-success"><span className="button-text">Login</span></Link>
                                </div>
